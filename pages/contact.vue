        ...
        >
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
            ...
            <div class="mb-12 lg:mb-0 text-center mx-auto">
              ...
              <h6 class="font-medium">{{ $t("dubai") }}</h6>
            </div>
            <div class="mb-6 md:mb-0 text-center mx-auto">
              ...
              <h6 class="font-medium" dir="ltr">+971 58 506 0092</h6>
            </div>
            <div class="text-center mx-auto">
              ...
              <h6 class="font-medium">info@tourexpect.com</h6>
            </div>
          </div>
            ...
            <form @submit.prevent="makeContact">
              ...
              <div class="form-group form-check text-center mb-6">
                ...
                <label
                  ...
                  for="subscribe_message"
                  >{{ $t("subscribe_message") }}</label
                >
              </div>

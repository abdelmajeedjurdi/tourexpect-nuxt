    ...
    <div class="pt-32">
        ...
        <div>
            ...
            <div class="flex justify-center items-center space-x-5">
                <div class="dot w-4 h-4 rounded-full cursor-pointer" @click="currentSlide(1)"></div>
                <div class="dot w-4 h-4 rounded-full cursor-pointer" @click="currentSlide(2)"></div>
                <div class="dot w-4 h-4 rounded-full cursor-pointer" @click="currentSlide(3)"></div>
            </div>

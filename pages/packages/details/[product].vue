      ...
      <div class="w-full md:w-3/4">
        <div class="w-full mb-8 px-2">
          ...
          <div
            ...
            v-if="product['banner_highlights']"
          >
            <div
              v-for="highlight in JSON.parse(product['banner_highlights'])"
              :key="highlight"
            >
              <div class="flex">
                <img
        ...
        <div
          v-if="
            product['options'] != undefined && product['options'].length > 5
          "
        ...
        >
          ...
          <div class="space-y-2 mt-4">
            <div
              v-for="(option, i) in JSON.parse(product['options'])"
              :key="option"
        ...
        <itinerary
          v-if="
            product['itinerary'] != undefined && product['itinerary'].length > 5
          "
          class="border py-2 mt-3"
          :section_list="JSON.parse(product['itinerary'])"
          section_title="itinerary"
        />
        <base-section
          v-if="
            product['description_' + locale] &&
            product['description_' + locale] != 'null'
          "
          class="border p-2 mt-3"
          :section_description="product['description_' + locale]"
          section_title="tour_overview"
        />
        <list-section
          v-if="
            product['highlights_' + locale] &&
            product['highlights_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :section_list="product['highlights_' + locale]"
          section_title="tour_highlights"
        />
        <include
          v-if="
            product['include_' + locale] &&
            product['include_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :includes="product['include_' + locale]"
          section_title="tour_inclusion"
        />
        <exclude
          v-if="
            product['exclude_' + locale] &&
            product['exclude_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :excludes="product['exclude_' + locale]"
          section_title="tour_exclusion"
        />

        <list-section
          v-if="
            product['information_' + locale] &&
            product['information_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :section_list="product['information_' + locale]"
          section_title="important_information"
        />
        <list-section
          v-if="
            product['policy_' + locale] && product['policy_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :section_list="product['policy_' + locale]"
          section_title="policy"
        />
        <list-section
          v-if="
            product['timing_and_transfer_' + locale] &&
            product['timing_and_transfer_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :section_list="product['timing_and_transfer_' + locale]"
        ...
        <list-section
          v-if="
            product['notes_' + locale] && product['notes_' + locale] != 'null'
          "
          class="border py-2 mt-3"
          :section_list="product['notes_' + locale]"
          section_title="notes"
        />
      </div>
      <div class="w-full md:w-1/4 mt-4">
        <div class="top-24">
          ...
          <div class="rounded-xl border border-blue-800 mt-4">
            ...
            <div class="p-3" v-if="product.title_en">
              <Inquire
                type="package"
...
let { data: product } = await useFetch(
  () => `single_package/${route.params.product}`,
  {

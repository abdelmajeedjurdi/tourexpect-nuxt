<template>
    <div>
        ...
        <div class="min-w-screen min-h-screen  flex justify-center container ">
            <div class=" text-gray-500   w-full overflow-hidden mt-3">
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900">Complete Your Info</h1>
                            <p>Enter your information to complete your design order</p>
                        </div>
                        <div>
                            <div class="flex -mx-3">

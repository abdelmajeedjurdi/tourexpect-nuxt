import { c as useFetch, d as _imports_0$1, e as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    let province_tours = vue_cjs_prod.ref(
      ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("http://127.0.0.1:8000/api/destination-tours", "$u9uKBP2bTH").data), __temp = await __temp, __restore(), __temp)
    );
    let countries = vue_cjs_prod.ref(
      ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("http://127.0.0.1:8000/api/trending-destinations", "$OwpNSuN6hl").data), __temp = await __temp, __restore(), __temp)
    );
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="http://127.0.0.1:8000/images/turkey.jpg" class="h-full w-full object-cover" alt="Product Image"${_scopeId}><div class="relative"${_scopeId}><div class="text-body-color absolute bottom-0 left-0 right-0 flex justify-between overflow-hidden text-base font-bold leading-relaxed text-indigo-800"${_scopeId}>`);
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img src="http://127.0.0.1:8000/images/uae.webp" class="h-full w-full object-cover" alt="Product Image"${_scopeId}><div class="relative"${_scopeId}><div class="text-body-color absolute bottom-0 left-0 right-0 flex justify-between overflow-hidden text-base font-bold leading-relaxed text-indigo-800"${_scopeId}>`);
            _push2(serverRenderer.exports.ssrRenderComponent(_component_router_link, {
              to: "/tours/uae",
...
//# sourceMappingURL=index.d3519c66.mjs.map

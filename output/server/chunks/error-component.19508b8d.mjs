...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.3fd556a6.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.528c1e73.mjs'));
...
//# sourceMappingURL=error-component.19508b8d.mjs.map

...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.f5ae2e1e.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.0414d588.mjs'));
...
//# sourceMappingURL=error-component.715373e6.mjs.map

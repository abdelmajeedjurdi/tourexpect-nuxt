...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.e506c447.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.ed641b3a.mjs'));
...
//# sourceMappingURL=error-component.3e8e0ed5.mjs.map

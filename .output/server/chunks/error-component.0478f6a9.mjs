...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.2de1ec5c.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500.48fbd420.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component.0478f6a9.mjs.map
